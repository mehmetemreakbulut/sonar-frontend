...
const StyledVisContainer = styled.div`
    height: ${(props:any) => (props.theme.expanded ? "100%;" : "80%;")}
    width: ${(props:any) => (props.theme.expanded ? "100%;" : "60%;")}
    top: ${(props:any) => (props.theme.expanded ? "0px;" : "inherit;")}
    left: ${(props:any) => (props.theme.expanded ? "0px;" : "inherit;")}
    z-index: ${(props:any) => (props.theme.expanded ? "10000;" : "0;")}
    position: fixed;

    @media (max-width: 1100px) {
        height: ${(props:any) => (props.theme.expanded ? "100%;" : "55%;")}
        width: ${(props:any) => (props.theme.expanded ? "100%;" : "90%;")}
    }
`;
    ...
    return (
        <div>
            <header>
                ...
                <p className="subtitle">A graph-based approach to exploring the depths of research networks</p>
            </header>
            <div className="App">
